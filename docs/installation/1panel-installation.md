...
![1panel](../assets/1panel/1panel.png)
...
![1panel-newapi](../assets/1panel/1panel-newapi.png)
...
![newapi-setting](../assets/1panel/newapi-setting.png)

!!! tip "确认安装"
    点击确认开始安装，页面自将动跳转到已安装应用列表，等待 New API 应用状态变为已启动

![newapi-start](../assets/1panel/newapi-start.png)
...
![newapi-visit](../assets/1panel/newapi-visit.png)
